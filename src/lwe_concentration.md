...
binding_model.conversion_rate = [0.0, 0.0, 9.4e39, 9.5, 0.0] #MSSMA_RATES = [1.0, rate_{0,0}, rate_{0,1}, rate_{1,0}, rate_{1,1}] = [comp0fromBnd0toBnd0,comp1fromBnd0toBnd0, comp1fromBnd0toBnd1, comp1fromBnd1toBnd0, comp1fromBnd1toBnd1]
...
column.diameter = 0.0115 #"1.2cm high column (3.1)"column geometry known from Äkta log book and manufacturing data (3.2)
...
column.pore_diffusion = column.n_comp*[9.0e-12] #porous beads, Dp = 9e-12
...
column.c = [69.97, 0] #initial salt conc.
...
salt_gradient = 0.053 #(500.0-69.97)/gradient_duration
process.cycle_time = gradient_duration + t_gradient_start

c_load = np.array([69.97, 0.106])  
c_wash = np.array([69.97, 0.0])
c_elute = np.array([69.97, salt_gradient])  # 15 CV(column volumes) salt gradient from 69.97 mM NaCl buffer to 500mM NaCl
...
process.add_event('elute','flow_sheet.inlet.c', list(c_elute), load_duration + wash_duration, indices =[(0,0), (0,1)])
